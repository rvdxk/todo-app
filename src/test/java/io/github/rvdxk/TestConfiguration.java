...
import static org.h2.command.dml.SetTypes.DB_CLOSE_DELAY;
...
public class TestConfiguration {
    ...
    TaskRepository testRepo() {
        return new TaskRepository() {
            ...
            @Override
            public List<Task> findAllByDoneIsFalseAndDeadlineIsNullOrDeadlineIsBefore(LocalDateTime deadlineNow) {
                return null;
            }
