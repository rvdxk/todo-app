...
class ProjectServiceTest {
    ...
    void createGroup_configurationOk_And_noProjects_throwsIllegalArgumentationException() {
        //given
    ...
    @Test
    @DisplayName("should throw IllegalArgumentException when configuration to allow just 1 group and no groups and no projects")
    void createGroup_noMultipleGroupsConfig_And_noUndoneGroupExists_noProjects_throwsIllegalArgumentationException() {
        //given
        var mockRepository = mock(ProjectRepository.class);
        when(mockRepository.findById(anyInt())).thenReturn(Optional.empty());
        //and
    ...
    private static class InMemoryGroupRepository implements TaskGroupRepository {
        ...
        @Override
        public boolean existsByDoneIsFalseAndProject_Id(final Integer projectId){return map.values().stream()
